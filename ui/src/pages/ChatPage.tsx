...
import { getProcesses, getConversations, getConversationMessages, deleteConversation } from '../api'
...
export function ChatPage() {
  ...
  // Sync conversations into store — use stable action selector to avoid infinite loop
  useEffect(() => {
      ...
      <main className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="border-b border-gray-200 dark:border-gray-800 px-6 py-3 flex items-center gap-3">
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">Ask questions about your trading logs</p>
          </div>
        </header>
            ...
            <div className="flex h-full items-center justify-center">
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Type <code className="rounded bg-gray-100 dark:bg-gray-800 px-1 py-0.5">/process-name</code> to focus on a specific process
                </p>
              </div>
            </div>
          )}
